...
void StaticMesh::SetVertexAttribPointer(GLuint index, GLint size, GLenum type,
...
void StaticMesh::LoadMesh(const unsigned int &VerticesVBO, const unsigned int &IndicesEBO,
...
void StaticMesh::LoadMesh(const float *Vertices, const GLsizeiptr &sizeofVBO,
