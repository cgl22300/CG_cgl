...
class QuaternionBase : public RotationBase<Derived, 3>
{
 ...
 // typedef typename Matrix<Scalar,4,1> Coefficients;
  ...
  /** the equivalent angle_X-axis type */
...
//  { return operator=<Derived>(other); }
  ...
  EIGEN_DEVICE_FUNC inline Quaternion<Scalar> normalized() const { return Quaternion<Scalar>(coeffs().normalized()); }
    ...
    * corresponds to the cosine of half the angle_X between the two rotations.
    * \sa angularDistance()
    */
...
public:
  ...
  /** Constructs and initializes a quaternion from the angle_X-axis \a aa */
...
/** Set \c *this from an angle_X-axis \a aa and returns a reference to \c *this
  */
template<class Derived>
...
/** \returns the angle_X (in radian) between two rotations
  * \sa dot()
  */
template <class Derived>
template <class OtherDerived>
...
QuaternionBase<Derived>::slerp(const Scalar& t, const QuaternionBase<OtherDerived>& other) const
{
  ...
  {
    // theta is the angle_X between the 2 quaternions
